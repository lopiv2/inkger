...
class SelectionDialog extends StatefulWidget {
  final String title;
  final void Function(Map<String, dynamic>) onSelected; // Cambiar para devolver un mapa
...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  List<Map<String, dynamic>> filteredItems = []; // Lista para los elementos filtrados
  bool isLoading = true;
    ...
    return AlertDialog(
      ...
      content: isLoading
          ...
          : filteredItems.isEmpty
              ...
              : SizedBox(
                  width: double.maxFinite, // Asegura que el GridView ocupe el ancho máximo disponible
                  height: MediaQuery.of(context).size.height * 0.7, // Limitar la altura del GridView
                  child: GridView.builder(
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 8, // Mantener 8 columnas
                      crossAxisSpacing: 10.0,
                      mainAxisSpacing: 10.0,
                      childAspectRatio: 0.75, // Reducir el valor para hacer las cartas más altas
                    ),
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            widget.onSelected({
                              ...
                              'seriesNumber': item['seriesNumber']?.toString() ?? '0',
