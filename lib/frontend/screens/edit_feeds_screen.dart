...
class _EditFeedsScreenState extends State<EditFeedsScreen> {
  void _showAddFeedDialog() async {
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(controller: urlController, decoration: InputDecoration(labelText: 'Dirección (URL)')),
    ...
    if (result != null && result['name'].isNotEmpty && result['url'].isNotEmpty) {
      final feedsProvider = Provider.of<FeedsProvider>(context, listen: false);
      feedsProvider.addFeed(result);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.add), tooltip: 'Agregar feed', onPressed: _showAddFeedDialog),
        ],
      ),
              ...
              cells: [
                ...
                DataCell(Switch(
                  ...
                  onChanged: (v) async {
                    ...
                    feedsProvider.updateFeed(i, updatedFeed);
                    if (feed.id != null) await FeedsService.updateFeed(feed.id!, updatedFeed);
                  },
                )),
                DataCell(Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        final logoController = TextEditingController(text: feed.logo);
                        ...
                        if (result != null && result['name'].isNotEmpty && result['url'].isNotEmpty) {
                          ...
                          feedsProvider.updateFeed(i, result);
                          if (feed.id != null) await FeedsService.updateFeed(feed.id!, result);
                        }
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (feed.id != null) await FeedsService.deleteFeed(feed.id!);
                      },
                    ),
                  ],
                )),
